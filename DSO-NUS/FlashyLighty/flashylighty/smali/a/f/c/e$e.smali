...
.method public a(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v3, La/f/c/e$e;->n:Landroid/util/SparseIntArray;
    ...
    iget v3, p0, La/f/c/e$e;->m:F

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, La/f/c/e$e;->m:F

    goto :goto_1

    :pswitch_1
    iget v3, p0, La/f/c/e$e;->k:F

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, La/f/c/e$e;->k:F

    goto :goto_1

    :pswitch_2
    iget v3, p0, La/f/c/e$e;->j:F

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, La/f/c/e$e;->j:F

    goto :goto_1

    :pswitch_3
    iget v3, p0, La/f/c/e$e;->i:F

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, La/f/c/e$e;->i:F

    goto :goto_1

    :pswitch_4
    iget v3, p0, La/f/c/e$e;->h:F
    ...
    :pswitch_8
    iget v3, p0, La/f/c/e$e;->d:F

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v2

    iput v2, p0, La/f/c/e$e;->d:F

    goto :goto_1

    :pswitch_9
    iget v3, p0, La/f/c/e$e;->c:F

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v2

    iput v2, p0, La/f/c/e$e;->c:F

    goto :goto_1

    :pswitch_a
    iget v3, p0, La/f/c/e$e;->b:F

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v2

    iput v2, p0, La/f/c/e$e;->b:F
