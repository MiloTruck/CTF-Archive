...
# static fields
.field public static final a:La/h/d/i;
...
.method public static constructor <clinit>()V
    ...
    :goto_0
    sput-object v0, La/h/d/c;->a:La/h/d/i;
    ...
    sput-object v0, La/h/d/c;->b:La/e/f;

    return-void
.end method

.method public static a(Landroid/content/Context;La/h/c/b/a;Landroid/content/res/Resources;IILa/h/c/b/e;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    .locals 4
    ...
    .line 3
    :goto_1
    iget-object p1, p1, La/h/c/b/d;->a:La/h/g/a;
    ...
    invoke-virtual {p5, v3}, La/h/c/b/e;->d(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {p5, p1, p6}, La/h/c/b/e;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V

    goto :goto_2

    :cond_4
    invoke-virtual {p5, p1, p6}, La/h/c/b/e;->a(ILandroid/os/Handler;)V
    ...
    invoke-direct {p0, p5, p6}, La/h/g/c;-><init>(La/h/c/b/e;Landroid/os/Handler;)V
    ...
    .line 11
    :cond_c
    sget-object p7, La/h/d/c;->a:La/h/d/i;

    check-cast p1, La/h/c/b/b;

    invoke-virtual {p7, p0, p1, p2, p4}, La/h/d/i;->a(Landroid/content/Context;La/h/c/b/b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p5, v3, p6}, La/h/c/b/e;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-virtual {p5, p0, p6}, La/h/c/b/e;->a(ILandroid/os/Handler;)V
    ...
    sget-object p0, La/h/d/c;->b:La/e/f;

    invoke-static {p2, p3, p4}, La/h/d/c;->c(Landroid/content/res/Resources;II)Ljava/lang/String;
...
.method public static b(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    sget-object v0, La/h/d/c;->a:La/h/d/i;
    ...
    invoke-virtual/range {v0 .. v5}, La/h/d/i;->c(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p1, p2, p4}, La/h/d/c;->c(Landroid/content/res/Resources;II)Ljava/lang/String;

    move-result-object p1

    sget-object p2, La/h/d/c;->b:La/e/f;
