...
.method public c(La/b/f/i/g;La/b/f/i/i;)Z
    ...
    invoke-virtual {p2}, La/b/f/i/i;->getActionView()Landroid/view/View;

    move-result-object v0

    iput-object v0, p1, Landroidx/appcompat/widget/Toolbar;->k:Landroid/view/View;

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->d:La/b/f/i/i;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->e:Landroidx/appcompat/widget/Toolbar;

    iget v3, v2, Landroidx/appcompat/widget/Toolbar;->p:I

    and-int/lit8 v3, v3, 0x70

    or-int/2addr v0, v3

    iput v0, p1, La/b/c/a$a;->a:I

    iput v1, p1, Landroidx/appcompat/widget/Toolbar$e;->b:I

    iget-object v0, v2, Landroidx/appcompat/widget/Toolbar;->k:Landroid/view/View;
    ...
    iget-object v3, p1, Landroidx/appcompat/widget/Toolbar;->G:Ljava/util/ArrayList;
    ...
    .line 3
    iput-boolean p1, p2, La/b/f/i/i;->C:Z

    iget-object p2, p2, La/b/f/i/i;->n:La/b/f/i/g;

    const/4 v0, 0x0

    invoke-virtual {p2, v0}, La/b/f/i/g;->q(Z)V
    ...
    instance-of v0, p2, La/b/f/b;

    if-eqz v0, :cond_6

    check-cast p2, La/b/f/b;

    invoke-interface {p2}, La/b/f/b;->a()V
...
.method public h(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->d:La/b/f/i/i;

    if-eqz p1, :cond_2

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->c:La/b/f/i/g;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->c:La/b/f/i/g;

    invoke-virtual {v2, v1}, La/b/f/i/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$d;->d:La/b/f/i/i;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->d:La/b/f/i/i;

    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$d;->k(La/b/f/i/g;La/b/f/i/i;)Z
...
.method public j(Landroid/content/Context;La/b/f/i/g;)V
    ...
    invoke-virtual {p1, v0}, La/b/f/i/g;->d(La/b/f/i/i;)Z

    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->c:La/b/f/i/g;
...
.method public k(La/b/f/i/g;La/b/f/i/i;)Z
    ...
    instance-of v0, p1, La/b/f/b;

    if-eqz v0, :cond_0

    check-cast p1, La/b/f/b;

    invoke-interface {p1}, La/b/f/b;->e()V
    ...
    .line 1
    iget-object v1, p1, Landroidx/appcompat/widget/Toolbar;->G:Ljava/util/ArrayList;
    ...
    iget-object v2, p1, Landroidx/appcompat/widget/Toolbar;->G:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p1, p1, Landroidx/appcompat/widget/Toolbar;->G:Ljava/util/ArrayList;

    invoke-virtual {p1}, Ljava/util/ArrayList;->clear()V

    .line 2
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->d:La/b/f/i/i;
    ...
    invoke-virtual {p2, p1}, La/b/f/i/g;->q(Z)V
